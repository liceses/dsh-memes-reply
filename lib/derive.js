 ...
 */
export const THINKING_IDS = ['sikao', 'dazi', 'sikao-renzhen', 'dazi-shengqi', 'sikao-zixin'];
...
/** 从词表里按 id 取一张。 */
export function termOf(entries, id) {
 ...
 */
export function thinkingStickerFor(entries, sessionId, turn) {
    const pool = THINKING_IDS.map((id) => termOf(entries, id)).filter((entry) => entry !== undefined);
...
export function finalStickerFor(input) {
...
/** 原因 → 人话（提示文案）。 */
export function reasonText(choice) {
